<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="margin: auto; display: block;" height="50px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
<circle cx="84" cy="50" r="10" fill="#5f2a62">
    ...
    <animate attributeName="fill" repeatCount="indefinite" dur="1.6949152542372883s" calcMode="discrete" keyTimes="0;0.25;0.5;0.75;1" values="#5f2a62;#466b5a;#a0de59;#a976c3;#5f2a62" begin="0s"></animate>
</circle><circle cx="16" cy="50" r="10" fill="#5f2a62">
...
</circle><circle cx="84" cy="50" r="10" fill="#a0de59">
...
</circle><circle cx="16" cy="50" r="10" fill="#466b5a">
